...
class ItemStrip extends Component<ItemStripProps, ItemStripState, any> {
    ...
    private load(source: string): void {
        if (source === 'Tweet') {
            this.props.importSource('/data/93.csv', '/data/visualization_tree_dict_0.2_0.1_0.0007.json', '/data/93-wordcount.json', '/data/00sentiment_dis-0.15-0.01-20.json', '/data/00sentiment_sum-0.15-0.01-20.json', '/data/prun.json');
        }
        else if (source === 'yelp') {
